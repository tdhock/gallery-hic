...
This is a gallery of data visualizations about [Hi-C](https://en.wikipedia.org/wiki/Hi-C_(genomic_analysis_technique)) analysis
...
meta.dt <- myread("meta.csv")[, let(
  ...
  video.link = ifelse(is.na(video) | video=="", "", ahref(video,  "video"))
)][
...
* [This gallery repository](https://github.com/tdhock/gallery-hic/tree/gh-pages),
